...
function PicoProxy(options) {
  ...
  this._corsOverrides = {
    'Access-Control-Allow-Headers': options.allowHeaders || 'Authorization',
    'Access-Control-Allow-Methods': options.allowMethods || 'GET,PUT,POST,DELETE,PATCH,OPTIONS',
    'Access-Control-Allow-Origin': options.allowOrigin || '*',
    'Access-Control-Allow-Credentials': options.allowCredentials || 'true'
  };
